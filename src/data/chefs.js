export const chefs = [
  {
    ...
    priceRange: '€€',
    bio: 'Passionnée par la cuisine sénégalaise depuis mon enfance, j\'ai grandi en apprenant les secrets culinaires de ma grand-mère à Dakar. Après 15 ans d\'expérience dans la restauration en Allemagne, je partage aujourd\'hui l\'authenticité des saveurs de mon pays natal avec la diaspora africaine et les amateurs de cuisine du monde entier.',
    experience: '15 ans',
